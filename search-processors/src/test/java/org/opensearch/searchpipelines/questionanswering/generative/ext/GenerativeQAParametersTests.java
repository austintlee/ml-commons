...
public class GenerativeQAParametersTests extends OpenSearchTestCase {
    ...
    public void testGenerativeQAParameters() {
        GenerativeQAParameters params = new GenerativeQAParameters("conversation_id", "llm_model", "llm_question", null, null, null, null);
    ...
    public void testWriteTo() throws IOException {
        ...
        GenerativeQAParameters parameters = new GenerativeQAParameters(conversationId, llmModel, llmQuestion, null, null, null, null);
    ...
    public void testMisc() {
        ...
        assertEquals(parameters, new GenerativeQAParameters(conversationId, llmModel, llmQuestion, null, null, null, null));
        assertNotEquals(parameters, new GenerativeQAParameters("", llmModel, llmQuestion, null, null, null, null));
        assertNotEquals(parameters, new GenerativeQAParameters(conversationId, "", llmQuestion, null, null, null, null));
